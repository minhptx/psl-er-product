 ...
 */
public abstract class MyVotedPerceptron extends WeightLearningApplication {
    private static final Logger log = LoggerFactory.getLogger(MyVotedPerceptron.class);
    ...
    /**
     * Key for positive integer property. MyVotedPerceptron will take this many
    ...
    public MyVotedPerceptron(List<Rule> rules, Database rvDB, Database observedDB,
                             boolean supportsLatentVariables) {
        super(rules, rvDB, observedDB, supportsLatentVariables);

        evaluator = new MyWeightedEvaluator();
    ...
    protected void doLearn() {
        ...
        ((MyWeightedEvaluator) evaluator).setWeight(10);
