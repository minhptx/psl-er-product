...
public class F1Evaluator extends Evaluator {
    ...
    public F1Evaluator(double threshold) {
        this(threshold, DEFAULT_REPRESENTATIVE);
    }

    public F1Evaluator(double threshold, String representative) {
        this(threshold, RepresentativeMetric.valueOf(representative.toUpperCase()));
    }

    public F1Evaluator(double threshold, RepresentativeMetric representative) {
